...
// UNDER CONSTRUCTION
const UnderConstruction = lazy(() => import(/* webpackChunkName: 'under-construction-page' */ './UnderConstruction'))
        ...
        >
          <Flex flexDirection="column" padding="24px" width="100%">
            ...
            <Text marginTop="24px" fontSize="14px" lineHeight={2}>
              ...
              result, it is blocked from using CryonSwap and all of its related services at this juncture.
            </Text>
            <Flex
              marginTop="24px"
              padding="12px"
