...
function Welcome() {
  return (
    <Layout>
      <img src={WelcomeImage} alt="welcome to cryonswap" style={{ maxWidth: '100%', marginTop: 10 }} />
      <Desc>
        <Trans>
          CryonSwap is a decentralized exchange (DEX) aggregator. We provide our traders with the{' '}
          <HighlightText>best token prices</HighlightText> by analyzing rates across thousands of exchanges instantly!
        </Trans>
      </Desc>
      <Desc>
        <Trans>
          CryonSwap is also an automated market maker (AMM) with industry-leading liquidity protocols and{' '}
      ...
      <Desc>
        <Trans>
          We created this <HighlightText>quick tutorial</HighlightText> guide for you to highlight CryonSwap&#39;s main
          features.
        </Trans>
      </Desc>
      <Desc>
...
function Step3({ videoStyle = {} }: { videoStyle: CSSProperties }) {
  ...
  return (
    <Layout title={LIST_TITLE.START_TRADING}>
      <Desc>
        <Trans>
          Select from over thousands of tokens and start trading. CryonSwap finds you the best prices across multiple
  ...
  return [
    {
      title: (
        <Heading style={{ fontSize: 20 }}>
          <Trans>Welcome to CryonSwap!</Trans>
        </Heading>
      ),
    ...
    },
    {
      ...
      description: (
        <Layout title={LIST_TITLE.SELECT_NETWORK}>
          <Desc>
            <Trans>
              Choose your preferred network. CryonSwap is a multi chain platform that supports over 12 networks!
            </Trans>
          </Desc>
